            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block" style="color:gold;">Miss Nzhelele.</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                  <h5 class="card-title text-center pb-0 fs-4" style="color:gold;">Login to Your Account</h5>
                  ...
                  <?php include 'database/flash-messages.php';?>
                    ...
                    <div class="col-md-12 mb-3">
                            <a href="database/password-reset" style="color:gold;">Forgot password?</a>
                        </div>
                    <div class="col-12">
                    <button class="btn btn-primary w-100" type="submit" name="login-btn" style="background:gold; border:1px solid gold;font-size:20px;">Login</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="register.php" style="color:gold;">Create an account</a></p>
                    </div>
