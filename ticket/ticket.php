...
$sql = "SELECT * FROM tickets WHERE email = '$email' AND status ='Paid'";
$result = mysqli_query($conn, $sql);
$paidNotPaid = mysqli_fetch_all($result, MYSQLI_ASSOC);
...
$ticketSale = $row['status'];
if($ticketSale == 'Not Paid'){
	...
	// echo $num_rows;
		echo "<div style='text-align: center; color: white; font-size:40px;'>You have $num_rows Unpaid Tickets</div>";
		"<br>";
			echo "<a href='../checkout.php'><div style='text-align: center; color: white; font-size:15px; text-decoration:none;'>View and Pay Tickets</div></a>";
}
?>
<?php 
...
foreach ($paidNotPaid as $key=> $ticket):?>
...
<div class="back" style="display:flex;justify-content:center;align-content:center;color:#fff;">&nbsp; Buy Ticket Now</div>
</a>
<a href="../home.php" style="text-decoration: none;">
<div class="back" style="display:flex;justify-content:center;align-content:center;color:#fff;">&nbsp; bact to home</div>
</a>
