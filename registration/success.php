...
if (!empty($goal)) {
  $fname = $goal[0]['fullname'];
  $lname = $goal[0]['lastname'];
  $email = $goal[0]['email'];
  $contest = $goal[0]['con_num'];
...
<head>
    ...
    <!-- Title Page-->
    <title>Miss Nzhelele | Success</title>
...
.topHalf {
  ...
  background: -webkit-linear-gradient(45deg, gold, #a0ebcf);
}
...
<div class="wrapperAlert">
  ...
  <?php foreach($goal as $key => $g):?>
    <div class="topHalf">
      ...
      <h1><?php echo $g['fullname'];?> <?php echo $g['lastname'];?></h1>
    ...
    <div class="bottomHalf">
      ...
      <p>Well Done!, you actually managed to List yourself to Miss Nzhelele...</p>
      <p>this is your contenstant number: <b> <?php echo $g['con_num'];?></b></p>
