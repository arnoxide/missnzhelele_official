...
<body>
    ...
    <div class="header">
        <div class="container">
            <div class="logo">
                <a href="index.html">
                    <img src="img/photo.jpg" alt="Logo" height="98px" width="100px">
                </a>
            </div>
                ...
                <div class="menu-content">
                    ...
                    <div class="hidden-xs">
                        ...
                        <div class="menu-information">
                            <ul>
                                <li><span>T:</span> +27 81 258 5734</li>
    ...
    <div class="container">
        <div class="header-page ef-parallax-bg" style="background-image:url(img/2023.jpg)">
                ...
                <div class="row">
                    <div class="inner-content">
                        <div class="header-content">
                            <h1>Contact Us</h1>
                            <hr>
                            <p>Heavy is the head that wears Miss Nzhelele Crown</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="contact-info">
                        ...
                        <span class="description-info">+27 81 258 5734</span>
                    </div>
                    ...
                    <div class="contact-info">
                        ...
                        <span class="description-info">Nzhelele, Limpopo, South Africa</span>
                    </div>
